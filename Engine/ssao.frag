...
uniform sampler2DRect u_randomJitterTex;  // Normalmap to randomize the sampling kernel
...
{
  // random jitter
//  vec2 randVec = normalize(texture2DRect(u_randomJitterTex, v_texCoord).xy * 2.0 - 1.0);
