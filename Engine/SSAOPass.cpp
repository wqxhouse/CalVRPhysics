...
SSAOPass::SSAOPass(osg::Camera *mainCamera, osg::TextureRectangle *positionTex, osg::TextureRectangle *normalTex, osg::TextureRectangle *randomJitterTex)
...
void SSAOPass::configureStateSet()
{
    ...
    _stateSet->setTextureAttribute(0, getInTexture(_in_random_tex));
